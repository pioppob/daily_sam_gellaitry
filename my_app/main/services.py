...
def set_default_thumbnail():
    ...
    thumbnail = os.path.join("/static/default_images/", thumbnail)
...
def add_one_file(filename):
    """
    This function is invoked by the ThreadPoolExecutor in the
    add_local_tracks method. This function requires an .mp3 file
    and optionally .jpg file stored somewhere on the local machine.
    """
